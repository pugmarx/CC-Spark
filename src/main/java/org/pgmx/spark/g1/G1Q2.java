...
public final class G1Q2 {
    ...
    private static JavaPairReceiverInputDStream<String, String> getKafkaMessageStream() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //lines.mapPartitions(iter -> Arrays(iter.).iterator, true);
            //lines.mapPartitions()
            ...
            //JavaPairDStream<String, Float> summarized = carrierArrDelay.reduceByKey((i1, i2) -> i1 + i2);
            //carrierArrDelay.mapPartitions(iter -> iter.next()., true);

            //JavaPairDStream<String, Float> summarized = carrierArrDelay.
